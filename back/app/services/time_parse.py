...
PRAISE_MESSAGES: list[tuple[int, list[str]]] = [
    (480, ["とんでもない集中力です…！しっかり休んでくださいね🛌", "8時間超え、完全に本気モードですね🔥 お疲れさまでした！"]),
    (300, ["5時間以上！すごい踏ん張りでした💪", "がっつり打ち込みましたね…！お疲れさまです🌙"]),
    (180, ["3時間集中、お見事です✨", "ここまで続けられるのは強い。よく頑張りました🔥"]),
    (120, ["2時間しっかり確保できましたね👏", "いい流れです、この調子！🚀"]),
    (60, ["1時間しっかり集中できましたね😊", "着実に積み上がっています📈"]),
    (30, ["積み重ねが将来に効きます🌱"]),
